...
#include <memory>
#include "../../DocAI/src/pages/DashboardPage.h"
...
QT_MOC_LITERAL(1, 14, 10), // "navigateTo"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9) // "pageIndex"

    },
    "DashboardPage\0navigateTo\0\0pageIndex"
};
...
void DashboardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->navigateTo((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DashboardPage::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DashboardPage::navigateTo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DashboardPage::navigateTo(int _t1)
{
