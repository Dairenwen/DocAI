...
#include <memory>
#include "../../DocAI/src/widgets/Sidebar.h"
...
QT_MOC_LITERAL(4, 27, 15), // "collapseToggled"
QT_MOC_LITERAL(5, 43, 9) // "collapsed"

    },
    "Sidebar\0pageChanged\0\0index\0collapseToggled\0"
    "collapsed"
};
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->collapseToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sidebar::collapseToggled)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Sidebar::collapseToggled(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
